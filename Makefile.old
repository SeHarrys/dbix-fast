...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/DBIx/Fast.pm $(INST_MAN3DIR)/DBIx::Fast.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '            "DateTime::Format::MySQL" : "0.04",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Harun Delgado &lt;hdp@nurmol.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
